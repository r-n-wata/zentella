...
export default function Music(){
    ...
    return (
        <section className="h-screen flex justify-center flex-col overflow-hidden relative items-center w-full" id="music">
            <img src={ background } alt='background' className='background desktop:w-screen desktop:h-screen desktop:h-[110vh] desktop:absolute'/>
            ...
            <section data-aos='fade-left' className="pt-8 pb-8 pl-8 pr-8 bg-black flex flex-col items-center w-4/5 text-gray-100">
                ...
                <p className='font-inter text-center leading-7 mt-4'>Es una sutil mezcla entre lo moderno y lo antiguo, reflexivo y lúdico, puede notarse influencias de compositores como Jorge Reyes reinventando patrones musicales que nos conecta con las raíces mexicanas precolombinas , así cómo ritmos folklóricos de Tabasco y Veracruz; el flamenco, la música balcánica, el jazz, rock progresivo, funk así como géneros más modernos como el low-fi hiphop, neosoul y trap.</p>
