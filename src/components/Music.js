...
export default function Music(){
    ...
    return (
        <section className="h-auto flex justify-center flex-col overflow-hidden relative pt-20 pb-20 items-center w-full desktop:h-screen" id="music">
            <img src={ background } alt='background' className='background brightness-50 max-w-[270%]  desktop:h-screen tablet:h-[120vh] desktop:h-[150vh] tablet:max-w-[100%] h-screen absolute desktop:w-[100vw] '/>
